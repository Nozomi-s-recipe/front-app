 ...
 * Based on specs/001-recipe-filter/data-model.md specification
 *
...
export const TIME_FILTER_OPTIONS: readonly TimeFilterOption[] = [
  { value: '0-15', label: '15分以内', range: { min: 0, max: 15 } },
  { value: '15-30', label: '15〜30分', range: { min: 15, max: 30 } },
  { value: '30-45', label: '30〜45分', range: { min: 30, max: 45 } },
  { value: '45-60', label: '45〜60分', range: { min: 45, max: 60 } },
  { value: '60+', label: '60分以上', range: { min: 60, max: Infinity } },
] as const;
...
export const INGREDIENT_FILTER_OPTIONS: readonly IngredientFilterOption[] = [
  { value: '0-5', label: '5個以下', range: { min: 0, max: 5 } },
  { value: '6-10', label: '6〜10個', range: { min: 6, max: 10 } },
  { value: '11-15', label: '11〜15個', range: { min: 11, max: 15 } },
  { value: '16-20', label: '16〜20個', range: { min: 16, max: 20 } },
  { value: '20+', label: '20個以上', range: { min: 20, max: Infinity } },
] as const;
...
// ============================================================================
// Helper Functions (T002, T003)
// ============================================================================

/**
 * Convert time range string to numeric min/max minutes
 * Implementation for T002
 */
export function timeRangeToMinutes(range: TimeRange): NumericRange {
  const ranges: Record<TimeRange, NumericRange> = {
    '0-15': { min: 0, max: 15 },
    '15-30': { min: 15, max: 30 },
    '30-45': { min: 30, max: 45 },
    '45-60': { min: 45, max: 60 },
...
/**
 * Convert ingredient range string to numeric min/max count
 * Implementation for T003
 */
export function ingredientRangeToCount(range: IngredientRange): NumericRange {
  const ranges: Record<IngredientRange, NumericRange> = {
    '0-5': { min: 0, max: 5 },
    '6-10': { min: 6, max: 10 },
    '11-15': { min: 11, max: 15 },
    '16-20': { min: 16, max: 20 },
